...
| |__| | | | | || (_) | | (_) | (_| | |_| |
 ...
 ':::'__   _____ _____  /    /
  ...
  print "Indicate the output file (file.rdf): "
  user = gets.chomp!
  ...
  puts ""
  print "Indicate the number of interactions (Integer): "
  puts ""
  interactions_number = gets.chomp!.to_i
  # return user params
  [output_file, interactions_number]
end
...
# Mine information
ontology_data = WebMining::get_info_from_web(initial:100_100,
