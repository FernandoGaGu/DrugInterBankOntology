...
module Ontology
  ...
  def Ontology.ontology_struct(params)
    rdf_triples = []
    # dibo_data:interaction_instance   rdf:ype  dibo_core:Drug
    ...
    # dibo_data:interaction_instance dibo_core:hasMolecularFormula MolecularFormula
    rdf_triples <<  generate_triplet({ subject: :dibo_data,
                                       predicate: :dibo_core,
                                       object: :xsd,
                                       subject_data: params['hasDrugBankId'],
    ...
    # dibo_data:interaction_instance dibo_core:hasMolecularMass MolecularMass
    rdf_triples <<  generate_triplet({ subject: :dibo_data,
                                       predicate: :dibo_core,
                                       object: :xsd,
                                       subject_data: params['hasDrugBankId'],
    ...
    # dibo_data:interaction_instance dibo_core:hasDrugBankId xsd:String
    rdf_triples <<  generate_triplet({ subject: :dibo_data,
                                       predicate: :dibo_core,
                                       object: :xsd,
                                       subject_data: params['hasDrugBankId'],
    ...
    # dibo_data:interaction_instance dibo_core:hasChebiId xsd:String
    rdf_triples <<  generate_triplet({ subject: :dibo_data,
                                       predicate: :dibo_core,
                                       object: :xsd,
                                       subject_data: params['hasDrugBankId'],
    ...
    # dibo_data:interaction_instance dibo_core:functionallyGroupedIn dibo_core:PharmacologicSubstance
    rdf_triples <<  generate_triplet({ subject: :dibo_data,
                                       predicate: :dibo_core,
                                       object: :dibo_core,
                                       subject_data: params['hasDrugBankId'],
    ...
    # dibo_data:interaction_instance dibo_core:hasHalfLife xsd:String
    rdf_triples <<  generate_triplet({ subject: :dibo_data,
                                       predicate: :dibo_core,
                                       object: :xsd,
                                       subject_data: params['hasDrugBankId'],
    ...
    # dibo_data:interaction_instance dibo_core:hasOtherName xsd:String
    ...
    params['hasTarget'].each do |target_info|
      ...
      if target_type == "Protein"
        rdf_triples <<  generate_triplet({ subject: :dibo_data,
                                           ...
                                           object_data: "#{target_info[4].upcase}" })
      end
  ...
  def Ontology.get_interaction_type(interaction)
    @interaction_types.each do |ontology_interaction, synonyms|
      if synonyms.include?(interaction.to_s.downcase)
        return ontology_interaction
      else
        puts "WARNING: Interaction type not present in synonyms list !!!!! -> #{ontology_interaction}"
      end
    end
    return 'Neutral'
  end
